 ...
 * @returns {Promise<any>}
 */
export function export_video(_video, progress_callback) {
    const ret = wasm.export_video(_video, progress_callback);
    return ret;
}
...
export class VideoProcessor {
    ...
    constructor(width, height) {
        const ret = wasm.videoprocessor_new(width, height);
        if (ret[2]) {
     ...
     */
    get width() {
        const ret = wasm.videoprocessor_width(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get height() {
        const ret = wasm.videoprocessor_height(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    load_frame(pixels) {
        ...
        const ret = wasm.videoprocessor_load_frame(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    get_frame() {
        const ret = wasm.videoprocessor_get_frame(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    frame_ptr() {
        const ret = wasm.videoprocessor_frame_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    frame_len() {
        const ret = wasm.videoprocessor_frame_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    apply_grayscale() {
        const ret = wasm.videoprocessor_apply_grayscale(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    apply_sepia() {
        const ret = wasm.videoprocessor_apply_sepia(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    apply_brightness(factor) {
        const ret = wasm.videoprocessor_apply_brightness(this.__wbg_ptr, factor);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('video_processor_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
